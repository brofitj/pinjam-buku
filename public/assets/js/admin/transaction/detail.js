$(function () {
    var $code = $('#transaction_detail_code');
    var $memberName = $('#transaction_detail_member_name');
    var $status = $('#transaction_detail_status');
    var $borrowDate = $('#transaction_detail_borrow_date');
    var $dueDate = $('#transaction_detail_due_date');
    var $returnDate = $('#transaction_detail_return_date');
    var $fineAmount = $('#transaction_detail_fine_amount');
    var $totalBooks = $('#transaction_detail_total_books');
    var $itemsBody = $('#transaction_detail_items_body');
    ...
    function loadDetail() {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $memberName.text(transaction.member_name || '-');
