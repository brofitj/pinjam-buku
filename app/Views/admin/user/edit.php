        ...
        <div class="kt-card min-w-full">
            <div class="kt-card-content flex flex-col gap-0 p-0">
                ...
                <form id="user_edit_form" enctype="multipart/form-data">
                    <input type="hidden" name="id" id="user_edit_id" value="<?= (int)($_GET['id'] ?? 0) ?>">
                    ...
                    <div class="form-row">
                        <div class="form-row-label"><label class="kt-form-label font-normal text-mono" for="role_label">Role</label></div>
                        <div class="form-row-field"><input id="role_label" type="text" class="kt-input w-full" value="" readonly /></div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row-field"><input id="password" type="password" name="password" class="kt-input w-full" placeholder="Kosongkan jika tidak diubah" value="" /></div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row-field">
                            <button class="kt-btn kt-btn-primary" id="user_edit_submit" type="submit">Simpan</button>
                        </div>
                    </div>
                </form>
            </div>
