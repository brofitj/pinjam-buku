    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="kt-card min-w-full">
            <div class="kt-card-content flex flex-col gap-0 p-0">
                ...
                <form id="book_add_form" enctype="multipart/form-data">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row-field">
                            <button class="kt-btn kt-btn-primary" id="book_add_submit" type="submit">Simpan</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script src="/assets/js/admin/book/add.js"></script>
