    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="kt-card min-w-full">
            <div class="kt-card-content flex flex-col gap-0 p-0">
                ...
                <form id="member_edit_form" enctype="multipart/form-data">
                    <input 
                        type="hidden" 
                        name="id" 
                        id="member_edit_id" 
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row-field">
                            <button class="kt-btn kt-btn-primary" id="member_edit_submit" type="submit">
                                Simpan
                            </button>
                        </div>
                    </div>
...
<script src="/assets/js/admin/member/edit.js"></script>
